  ...
  return (
    <footer className="relative bg-ink-deep text-white/70 mt-auto">
      ...
      <div className="hidden sm:grid w-full mx-auto max-w-6xl px-4 py-10 gap-8 md:grid-cols-3">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-green">Contact Us</p>
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <a href="tel:+233500001234" className="hover:text-green transition-colors">
                Phone: +233 50 000 1234
              </a>
            </li>
            <li>
              <a href="https://wa.me/233500001234" target="_blank" rel="noreferrer" className="hover:text-green transition-colors">
                WhatsApp: +233 50 000 1234
              </a>
            </li>
            <li>
              <a href="mailto:hello@eggys.example.com" className="hover:text-green transition-colors break-all">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-green">Quick Links</p>
          <ul className="mt-3 space-y-2 text-sm">
            <li><Link to="/products" className="hover:text-green transition-colors">Shop the Collection</Link></li>
            <li><Link to="/favorites" className="hover:text-green transition-colors">Favourites</Link></li>
            {cartCount > 0 && <li><Link to="/cart" className="hover:text-green transition-colors">Cart</Link></li>}
            <li><Link to="/account" className="hover:text-green transition-colors">My Account</Link></li>
            <li><Link to="/track-order" className="hover:text-green transition-colors">Track Order</Link></li>
            <li><Link to="/rider" className="hover:text-green transition-colors">Rider Portal</Link></li>
          </ul>
        </div>
      </div>
